...
// 3. Задание цвета текста и заливки ФиО 1 – выпад. список назв. (пять и более);    DONE
...
// 7. Присвоение номера ФиО 2 – вручную из УО;               DONE
// 8. Возможность смены номера ФиО из УО 2 - да              !!!
// 9. Регулировка скорости перемещения выбран-го ФиО 1 – указанием в текст. поле;                   DONE
// 10. Изменения размера окна отображения ФиО 2 – да; (т.е. отражение ФиО в новых границах)         DONE
...
//		private TextField   inputSpeedY;
		...
		MainFrame() throws IOException {
			...
			File file = new File("src/laba6/pick.png");
			image = ImageIO.read(file);
		}

		private void initializeChangeFigureNumbers() {
			figureNumberText = new TextField("Укажите Номер фигуры");
...
//			inputSpeedX = new TextField();
//			controlFrame.add(inputSpeedX);
//
//			inputSpeedY = new TextField();
//
//			controlFrame.add(inputSpeedY);
		}
		...
		private void changeFigureByIndex(int figureIndex) {
			...
			figure.setSpeedX(Integer.parseInt(speedTextX.getText()));
			figure.setSpeedY(Integer.parseInt(speedTextY.getText()));
...
//			switch (inputSpeedX.getSelectedIndex()) {
//				case 0:
//					return 1;
//				case 1:
//					return 2;
...
//			switch (inputSpeedY.getSelectedIndex()) {
//				case 0:
//					return 1;
//				case 1:
//					return 2;
